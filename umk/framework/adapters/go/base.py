...
class BuildOptions(kit.cli.Options):
    ...
    class Cover(kit.cli.Options):
        ...
        pkg: list[str] = core.Field(
            ...
            cli=kit.cli.List(name="-coverpkg"),
    ...
    class Profiling(kit.cli.Options):
        race: None | bool = core.Field(
            default=None,
            cli=kit.cli.Bool(name="-race"),
    ...
    class Mod(kit.cli.Options):
        strategy: None | str = core.Field(
            default=None,
            cli=kit.cli.Str(name="-mod"),
        ...
        cacherw: None | bool = core.Field(
            default=None,
            cli=kit.cli.Bool(name="-modcacherw"),
    ...
    installsuffix: None | str = core.Field(
        default=None,
        cli=kit.cli.Str(name="-installsuffix"),
    ...
    linkshared: None | bool = core.Field(
        default=None,
        cli=kit.cli.Bool(name="-linkshared"),
    ...
    trimpath: None | bool = core.Field(
        default=None,
        cli=kit.cli.Bool(name="-trimpath"),
